  ...
  <form method="post" action="ProductoController?accion=edit" enctype="multipart/form-data">
  	...
  	<div class="form-group">
  	  <label>Producto</label>
                ...
                <select class="form-select" name="categoria" autofocus=""  required="">
     ...
     <div class="form-group">
  	...
  	<div class="form-group">
  		...
  		<input type="text" class="form-control" name="nombre" id="nombre" placeholder="Ingrese el Nombre del Producto" value="${producto.nombreProducto}"/>
  	</div>
  	
  	<div class="form-group">
  		<label for="precio">Precio</label>
  		<input type="text" class="form-control" name="precio" id="precio" placeholder="Ingrese el Precio" value="${producto.precioProducto}"/>
  	</div>
  	
  	<div class="form-group">
  		<label for="descripcion">Contrasena</label>
  		<input type="text" class="form-control" name="descripcion" id="descripcion" placeholder="Ingrese la Descripcion" value="${producto.descripcionProducto}"/>
  	</div>
