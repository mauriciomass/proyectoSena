 ...
 <div class="mdl-cell mdl-cell--4-col-phone mdl-cell--8-col-tablet mdl-cell--8-col-desktop mdl-cell--2-offset-desktop">
  ...
  <form method="post" action="ProveedorController?accion=editProveedor">
  	...
  	<div class="form-group">
  		...
  		<input type="text" class="form-control" name="direccion" id="direccion" onBlur="verifyProveedorEdit()" placeholder="Ingrese la dirección del proveedor" value="${proveedor.direccionProveedor}"/>
  		
  		<div id="msndireccionVal" class="text-danger"> </div>
  		
  		<label for="telefono">Teléfono del Proveedor</label>
  		<input type="text" class="form-control" name="telefono" id="telefono" onBlur="verifyProveedorEdit()" placeholder="Ingrese el teléfono del proveedor" value="${proveedor.telefonoProveedor}"/>
